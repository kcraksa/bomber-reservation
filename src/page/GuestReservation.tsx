            ...
            <div className='w-1/2'>
              ...
              <div className='bg-black01 rounded-lg p-3'>
                ...
                <div className='flex w-full flex-col items-start p-3'>
                  ...
                  <input type='text' placeholder='name' className='w-full rounded-lg bg-[#000]' />
                </div>
                <div className='flex w-full flex-col items-start p-3'>
                ...
                <div className='flex w-full flex-col items-start p-3 mb-3'>
                  <div className='text-sm mb-3'>Phone</div>
                  <input type='text' placeholder='phone' className='w-full rounded-lg bg-[#000]' />
                </div>
